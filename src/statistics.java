...
public class statistics extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(319, 61, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 91, 580, 122));

        jLabel2.setBackground(new java.awt.Color(255, 204, 204));
        jLabel2.setFont(new java.awt.Font("Sylfaen", 1, 14)); // NOI18N
        jLabel2.setText("Return Details");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(309, 231, -1, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 261, 580, 120));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/frame.png"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 10, 700, -1));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try
        {
            ...
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));//table me bnake print krne k liye data ko
            ...
            jTable2.setModel(DbUtils.resultSetToTableModel(rs1));//table me bnake print krne k liye data ko
        }
        catch(Exception e)
        {
